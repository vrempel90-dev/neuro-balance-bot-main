...
# Суббота в клинике — процедурный день, воскресенье — выходной: консультации
# в оба дня не ведутся. Раньше это правило жило в weekend_booking_policy.py, который
...
6. Консультации врача проводятся только с понедельника по пятницу. Суббота —
   процедурный день, воскресенье — выходной. На субботу и воскресенье
   консультацию не предлагай, предоплату за такую запись не запрашивай.
...
async def _tool_get_available_slots(
    ...
    if weekend_requested:
        note = (
            "Пациент просил выходной для консультации: суббота — процедурный день, "
            "воскресенье — выходной. Консультаций в эти дни нет. Не предлагай предоплату; "
            "объясни правило и предложи окошки ближайшего рабочего дня. " + note
        )
