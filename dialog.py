...
def _has_mri_question(text: str) -> bool:
    ...
    ru_kz_diagnostics = [
        "мрт", "мрt", "кт", "рентген", "снимок", "снимки", "снимка",
        "томография", "диагностика", "диагностик", "обследование",
        "тексеру", "тексеріс", "тексерис", "сурет", "суретке", "снимкаға",
        "снимкага", "мртға", "мртга", "мрт түсу", "мрт тусу",
        "кт түсу", "кт тусу", "рентгенге түсу", "рентгенге тусу",
    ]

    if any(w in low for w in ru_kz_diagnostics):
        return True
