...
def _ask_contra(session: dict[str, Any]) -> str:
    return _tr(
        session,
        "Спасибо 🌿 Перед записью уточню противопоказания для безопасности. Подскажите, пожалуйста, нет ли у Вас кардиостимулятора, беременности, онкологии, металла в зоне лечения, эпилепсии, тромбоза/нарушения свёртываемости, высокой температуры или острой инфекции? Также приём не проводится пациентам младше 16 или старше 75 лет, а также при ограниченной подвижности — коляска, костыли. Противопоказаний нет?",
        "Жақсы 🌿 Жазылу алдында қауіпсіздік үшін қарсы көрсетілімдерді нақтылаймын. Сізде кардиостимулятор, жүктілік, онкология, емдеу аймағында металл, эпилепсия, тромбоз/қан ұю бұзылысы, қызу немесе жедел инфекция жоқ па? Сондай-ақ 16 жасқа дейінгі, 75 жастан асқан және қозғалысы шектеулі пациенттерге қабылдау жүргізілмейді. Қарсы көрсетілімдер жоқ па?",
    )
